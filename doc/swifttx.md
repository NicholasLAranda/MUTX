...
This mechanism has been integrated into Bitcore-Node-Mutx which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/mutx/insight-api-mutx#web-socket-api](https://github.com/mutx/insight-api-mutx#web-socket-api)
* API: [https://github.com/mutx/insight-api-mutx#swifttx-transactions](https://github.com/mutx/insight-api-mutx#swifttx-transactions)
...
By default, the Mutx Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Mutx Core daemon:
