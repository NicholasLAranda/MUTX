...
Intro
-----
Mutx (MUTX) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Mutx utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run mutx-qt.exe.

Mutx Core is the original Mutx client and it builds the backbone of the network.
However, it downloads and stores the entire history of Mutx transactions;
