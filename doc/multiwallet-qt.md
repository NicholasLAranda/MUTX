...
In order to support loading of multiple wallets in mutx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mutx.cpp.
...
Changes to mutx.cpp
----------------------
mutx.cpp is the entry point into mutx-qt, and as such, will require some minor modifications to provide hooks for
