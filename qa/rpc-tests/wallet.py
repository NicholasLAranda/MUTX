...
#   c) node1 mines 32 blocks, so now node 0 has 500000MUTX, node 1 has 4250MUTX, node2 has none.
#   d) node0 sends 601 MUTX to node2, in two transactions (301 MUTX, then 300 MUTX).
