                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Mutx Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MUTX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mutx: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Mutx Core"), this);
    aboutAction->setStatusTip(tr("Show information about Mutx Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Mutx"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MUTX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MUTX addresses"));
    ...
    openAction->setStatusTip(tr("Open a mutx: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Mutx Core help message to get a list with possible Mutx command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Mutx Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::gotoHistoryPage()
{
    ...
    if (walletFrame) {
		...
		this->setStyleSheet(GUIUtil::loadStyleSheet2());
	}
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Mutx network", "", count));
}
...
{
    QString strTitle = tr("Mutx Core"); // default title
