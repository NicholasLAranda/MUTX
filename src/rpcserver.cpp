...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Mutx features */
        {"mutx", "masternode", &masternode, true, true, false},
        {"mutx", "listmasternodes", &listmasternodes, true, true, false},
        {"mutx", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mutx", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mutx", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mutx", "masternodedebug", &masternodedebug, true, true, false},
        {"mutx", "startmasternode", &startmasternode, true, true, false},
        {"mutx", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mutx", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mutx", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mutx", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mutx", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mutx", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mutx", "mnbudget", &mnbudget, true, true, false},
        {"mutx", "preparebudget", &preparebudget, true, true, false},
        {"mutx", "submitbudget", &submitbudget, true, true, false},
        {"mutx", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mutx", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mutx", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mutx", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mutx", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mutx", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mutx", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mutx", "checkbudgets", &checkbudgets, true, true, false},
        {"mutx", "mnsync", &mnsync, true, true, false},
        {"mutx", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> mutx-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:25630/\n";
}
