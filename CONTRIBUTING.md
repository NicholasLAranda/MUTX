Contributing to Mutx Core
==================================

The Mutx Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Mutx Core project, and is not to be
confused with overall Mutx Network Protocol consensus changes.

Whether a pull request is merged into Mutx Core rests with the project merge
...
Patches that change Mutx consensus rules are considerably more involved than
...
Where a patch set proposes to change the Mutx consensus, it must have been
...
The project leader is the release manager for each Mutx Core release.
